(ns q9-oracle
  "The Clojure side of the whole-component acceptance: run `airbus-analytx.main` under
   ...
   result."
  (:require [airbus-analytx.main :as m]
...
(println "; oracle = airbus-analytx.main under nbb")
